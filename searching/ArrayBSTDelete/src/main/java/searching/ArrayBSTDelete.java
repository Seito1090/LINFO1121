...
public class ArrayBSTDelete<Key extends Comparable<Key>, Value> {
    ...
    public ArrayList<Boolean> deletions;
    ...
    public Value get(Key key) {
        ...
        return deletions.get(i) == false ? values.get(i): null;
    }
    ...
    public boolean delete(Key key) {
        ...
        if (idx != NONE && deletions.get(idx) != true){
            deletions.set(idx, true);
            return true;
        }
        return false;
    }
